...
from model_utils.initializations_utils import initialize_experiment, initialize_model
from model_utils.G_utils import collate_dgl, collate_dgl_train, move_batch_to_device_dgl, move_batch_to_device_dgl_train

from models.dglnet.graph_classifier import GraphClassifier as dgl_model

from modes.evaluator import Evaluator
from modes.trainer import Trainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_nei_rels', type=int, default=10, help='')
    parser.add_argument('--nei_rels_dropout', type=float, default=0.4, help='')
    parser.add_argument('--is_comp', type=str, default='mult', choices=['mult', 'sub'], help='T')
    parser.add_argument('--comp_ht', type=str, choices=['mult, mlp, sum'], default='sum', help='')
    parser.add_argument('--comp_hrt', type=str, choices=['TransE, DistMult'], default=None, help='')
    parser.add_argument('--coef_dgi_loss', type=float, default=5, help='Coefficient of MI loss')
    parser.add_argument('--init_nei_rels', type=str, choices=['no', 'out', 'in', 'both'], default='in', help='')
